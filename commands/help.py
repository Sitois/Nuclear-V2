...
class HelpCommands(commands.Cog):
  ...
  📂| __**{langs.help_utils[config_selfbot.lang]}:**__ `{config_selfbot.prefix}utils`
  🎤| __**{langs.help_voice[config_selfbot.lang]}:**__ `{config_selfbot.prefix}voice`
  🕹️| __**{langs.help_rich_presence[config_selfbot.lang]}:**__ `{config_selfbot.prefix}presence`
  📖| __**{langs.help_templates[config_selfbot.lang]}:**__ `{config_selfbot.prefix}templates`
  🎲| __**{langs.help_fun[config_selfbot.lang]}:**__ `{config_selfbot.prefix}fun`
  🏯| __**{langs.help_raid[config_selfbot.lang]}:**__ `{config_selfbot.prefix}raid`
  🔧| __**{langs.help_tools[config_selfbot.lang]}:**__ `{config_selfbot.prefix}tools`
  ⚙️| __**{langs.help_config[config_selfbot.lang]}:**__ `{config_selfbot.prefix}config`
  🗃️| __**{langs.help_backup[config_selfbot.lang]}:**__ `{config_selfbot.prefix}backup`""", delete_after=config_selfbot.deltime)
...
🗃️| __**Backup:**__
 ...
 `{config_selfbot.prefix}save {langs.optional[config_selfbot.lang]}[<server_id>]`: {langs.help_backup_save[config_selfbot.lang]}
 `{config_selfbot.prefix}load <backup_id> {langs.optional[config_selfbot.lang]}[<server_id>]`: {langs.help_backup_load[config_selfbot.lang]}
